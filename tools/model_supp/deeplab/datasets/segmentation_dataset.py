...
_CFD_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 71 ,  # num of samples in images/training
        'trainval': 71,
        'val': 71,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=44,
)
...
_AIGLE_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 24,  # num of samples in images/training
        'trainval': 24,
        'val': 24,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=44,
)

_AIGLE_CFD_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 95,  # num of samples in images/training
        'trainval': 95,
        'val': 95,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=44,
)

_DEEPCRACK_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 300 ,  # num of samples in images/training
        'trainval': 300,
        'val': 300,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=44,
)
...
_DATASETS_INFORMATION = {
    ...
    'CFD': _CFD_INFORMATION,
    'aigle': _AIGLE_INFORMATION,
    'deepcrack': _DEEPCRACK_INFORMATION,
    'aigle_CFD': _AIGLE_CFD_INFORMATION,
}
