...
import deeplab.scripts.crack_flags as crack_flags
...
flags.DEFINE_string('class_weight', None, 'Weight used during loss calculation for class 1')
...
def main(unused_argv):
  crack_flags.class_weight = FLAGS.class_weight
...
if __name__ == '__main__':
  ...
  flags.mark_flag_as_required('class_weight')
  tf.app.run()
